...
public class MapPolylineImpl extends MapObjectImpl implements MapPolygon {
    ...
    public void paint(Graphics g, Polygon polygon) {
        ...
        Point p = new Point(polygon.xpoints[polygon.npoints/2],polygon.ypoints[polygon.npoints/2]);
