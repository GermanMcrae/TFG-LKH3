...
public class OsmTileSource {
    ...
    /**
     * The default "OSM France" OSM tile source.
     */
    public static class OSMFrance extends AbstractOsmTileSource {

        private static final String PATTERN = "https://%s.tile.openstreetmap.fr/osmfr";
        ...
        /**
         * Constructs a new {@code "MapnOSM Franceik"} tile source.
         */
        public OSMFrance() {
            super("OSM France", PATTERN, "standard");
            modTileFeatures = true;
        }
    ...
    public static class Transport extends AbstractOsmTileSource {
        ...
        /**
         * Constructs a new {@code "Transport"} tile source.
         */
        public Transport() {
            super("Tranport Demo", PATTERN, "standard");
            modTileFeatures = true;
        }
